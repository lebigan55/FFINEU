            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-column-left">
                        <a href="http://freedom.goldpromo.com/index-eng.php"><img src="images/logo-footer.png" alt="logo"></a>
                    ...
                    <div class="footer-column-right">
                        ...
                        <div class="flag">
                            <ul>
                                ...
                                <li>
                                    <a href="http://freedom.goldpromo.com/">Русский</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div id="small-dialog" class="zoom-anim-dialog mfp-hide">        
        <div class="top-form-wrap remodal-form-wrap" >
            ...
            <form action="form-control/mail.php" method="post" id="modal-form-1" class="main-form-top" name="main-form">    
